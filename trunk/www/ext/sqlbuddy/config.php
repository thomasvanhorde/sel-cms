...
$sbconfig['DefaultAdapter'] = BDD_TYPE;
$sbconfig['DefaultHost'] = BDD_SERVER;
$sbconfig['DefaultUser'] = BDD_LOGIN;
...
// MySQL
 $sbconfig['DefaultPass'] = BDD_PWD;

// SQLite
$sbconfig['DefaultDatabase'] = BDD_BASE;
...
echo '<script>var BDD = "'.$sbconfig['DefaultDatabase'] .'"; </script>';
?>